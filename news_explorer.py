...
class NewsApp:
    def __init__(self):
        #fetch data
        # self.data = requests.get('https://newsapi.org/v2/top-headlines?country=us&apiKey=24c2db5cd90c4ae8afc45234d55456b2').json()
        self.data = requests.get('https://newsapi.org/v2/top-headlines?sources=google-news-in&apiKey=24c2db5cd90c4ae8afc45234d55456b2').json()
        #print(data)
